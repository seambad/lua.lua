...
-- Устанавливаем обработчик загрузочного экрана с небольшой задержкой, чтобы он был последним
    ...
    local misc = { } do
        ...
        local trashtalk do
            ...
            local PHRASES = {
                kill = {
                    1, {
                        { 'god bless no stress ты опущен by +w.tech хуесос' },
                        { 'owned by DODO corporation' },
                        { 'сочник ебанный', 'сиди в дэде' },
                        { 'в следующий раз заходи с +w.tech чтобы не позорится' },
                        ...
                        { 'ебанный хуесос', 'который раз ты лежишь в ногах юзера +w.tech?' },
                        { 'в очередной раз этот сочник у меня в ногах' },
                        { 'норм мисаешь, сын бляди' },
                        { 'переигран хуесос' },
                        { 'ебанный бич', 'почему ты сдох? оправдайся' },
                        { 'луасенс не бустит - +w.tech поможет сын шалавы' },
                        { 'ты че мразота ? вздумал тягатся с +w.tech юзером?' },
                        { '1 бот ты чо не вывез +w.tech system aa' },
                        { 'сын шлюхенции ты чет слабый для +w.tech' },
                        { 'я призываю свою Ōtsutsuki банду 5x5}, все +w.tech users были' },
                        { 'членом придавил тебя buy +w.tech' },
                        { 'ЫВЗ9ГРШО4УГР9ЗУЦКЕНРТГЗ9 тупейший без +w.tech :3' },
                        { 'че ты опять хнычешь в чат, покупай +w.tech и будь т1' },
                        { ' убил бомжа без +w.tech' },
                        { 'Только умные люди играют с +w.tech' },
                        { 'почему я опять тя убил пидораса? У меня куплен +w.tech' },
                    }
                },
